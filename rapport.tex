...
MC metoden er ofte brugt i tilfælde hvor en analytisk løsning til et problem  enten meget omstændig, eller praktisk umulig. MC metoden er opkaldt efter byen i Monaco som er mest kendt for et stort casino. Navnet kommer da MC metoden benytter en serie tilfældige tal til at indsamle statistik omkring et problem, der efter tilstrækkeligt mange gentagelser giver et meget beskrivende billede af en situation. 

I vores tilfælde benytter vi MC metoden til at lave ray tracing, dette betyder at vi tager nogle tilfældige tal og bruger dem til at definere en stråle af neutroner, denne har nogle parametre så som hastighed og retning. 
Ud fra disse  kigger vi på hvad strålen rammer, dette kunne for eksempel være et simuleret spejl, hvorefter vi regner vha. sandsynligheder hvor meget af denne stråle vil blive sendt videre, herefter opdaterer strålens parametre med ny retning og hastighed. 
...
Når strålen rammer en detektor optages alt informationen vi har indsamlet indtil nu, og vores vægtninger giver så et udtryk af hvor mange neutroner vil komme frem til denne detektor givet vores startbetingelser defineret af vores neutronkilde. \cite{wiki:monte_carlo}
...
Denne simulering blev fremstillet for at fremhæve forskellen mellem en lige guide, og en elliptisk guide. 

\subsubsection{Det simpleste ESS tilfælde}
Denne guide blev fremstillet for at simulere det simpleste tilfælde man kan forestille sig ved ESS.

\subsubsection{Realistisk ESS geometri}
Denne guide tager udgangspunkt en guidegeometri som har været under overvejelse til forsøget på ESS.
