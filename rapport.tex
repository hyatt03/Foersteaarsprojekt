...
Dansk:
\\
Vi har arbejdet med simulering af neutronoptik med formål at forbedre transporten af neutroner fra kilde til prøve. Dette er udført ved at lave et sæt parameteriserede neutron instrumenter i Monte Carlo simuleringspakken McStas hvorefter vi har fremstillet et computerprogram der automatisk kunne optimere på de relevante parametre. Vi har taget udgangspunkt i kravene til HEIMDAL eksperimentet ved ESS i Lund som bliver designet af Københavns Universitet. 
\\

English:
\\
This report describes our work in simulating neutronoptics aimed at improving transport efficiency of the neutrons from source to sample via a neutronguide. For this purpose we have utilized a Monte Carlo ray tracing simulation package, McStas. We have archived this by constructing a set of parameterised simulations that allow for automatic optimization. This report is based in the problems and limitations of the HEIMDAL instrument at ESS in Lund which is, as of writing, being designed by Copenhagen University.
