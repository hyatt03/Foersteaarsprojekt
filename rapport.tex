...
\linespread{1.2} % linjeafstand 1.5
...
Dansk:
\\
Vi har arbejdet med simulering af neutronoptik, med det formål at forbedre transporten af neutroner fra kilde til prøve. Dette er udført ved at lave et sæt parameteriserede neutron instrumenter i ray tracing simuleringspakken McStas, hvorefter vi har fremstillet et computerprogram, der automatisk kunne optimere på de relevante parametre. Vi har taget udgangspunkt i kravene til BIFROST instrumentet ved ESS i Lund, som bliver designet af Københavns Universitet. Vi når frem til en guide der har en høj ydeevne, defineret ved brilliance transfer, som for vores guide er over 0.5 for de fleste bølgelængder, der har en pris på $1.84\text{M€}$, hvilket er inden for vores budget.
\\
...
Senere forsøgte vi også at tage højde for m-værdiernes pris, så vi kunne få en god mellemvej mellem pris og kvalitet af m-værdier. Vi har altså basalt set optimeret på geometri, m-værdi og pris. Alt dette er i første omgang bedømt på baggrund af arealet under vores brilliance transfer kurve ved bølgelængder mellem 0.5Å og 8Å. Derefter har vi også kigget på, om vores optimeringer overholder pris- og divergenskrav. I vores script har vi eksempelvis taget højde for, at det ikke er godt, at få en høj brilliance transfer, hvis mange af neutronerne kommer med en divergens større end $\pm0.75^\circ$. Derfor kan vores optimering give os et godt bud på, hvordan en god og realistisk neutronguide kunne se ud.

Konkret har vi benyttet Tree of Parzen Estimators algoritmen til at optimere vores geometrier, det er en algoritme der udplukker nogle prøve værdier der er jævnt fordelt over et interval, hvorefter den fitter disse resultater og benytter det fit til at finde nogle nye prøve værdier. På den måde får algoritmen gradvist forbedret modellen for parametrene over tid, som giver os et bedre estimat på hvad vores optimale betingelser er. Vi har sikret at vores guides levede op til divergenskrav ved at begrænse vores brilliance måler til kun at optage neutroner der lever op til vores krav, på den måde straffes geometrier der tillader alt for store divergenser.

Vores m og pris optimeringer har været præget af en mere manuel tilgang, her har vi ladet vores m-værdier været bestemt ved et tredjegradspolynomium, hvor vi har justeret konstanterne og kørt en simulering for at se resultatet, som består af en graf over brilliance transfer med pris og areal under grafen skrevet i grafens titel.
