...
Når strålen rammer en detektor optages alt informationen vi har indsamlet indtil nu, og vores vægtninger giver så et udtryk af hvor mange neutroner vil komme frem til denne detektor givet vores startbetingelser defineret af vores neutronkilde. \cite{wiki:monte_carlo} \cite{thesis:sonja}
